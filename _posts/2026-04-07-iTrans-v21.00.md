---
layout: single
title: "가장 빠른 iDevice용 동영상 변환기 iTrans 21.00 업데이트"
date: 2026-4-7 13:59:00 +0900
categories:
  - iDevice
tags: ["ffmpeg"]
toc: true
...
{% include bnl_download-box.html
   file="/attachment/2026-04-07d/iTrans_v21.00.rar"
...
[FFmpeg](http://ffmpeg.org/download.html), [MediaInfo](http://mediainfo.sourceforge.net/en), [MP4Box](https://gpac.wp.imt.fr/), [fdkaac](https://github.com/nu774/fdkaac)
...
- 2026.4.7꞉ v21.00
  - 오픈소스 라이선스 표시 기능 추가
  - 오류 수정
    - **MainConcept hybrid** 옵션 적용 오류 수정
    - PAR이 1:1이 아닌 경우 **화면비가 잘못 계산**되던 오류 수정
  - UI 개선
    - 변환 중에도 목록이 스크롤 가능하도록 수정
    - 화면 색상 튜닝
  - 내부 어플리케이션/라이브러리 업데이트 및 변경
    - [FFmpeg](http://ffmpeg.org/download.html)을 8.1\[gyan.dev\]로 업데이트
    - [MediaInfo](http://mediainfo.sourceforge.net/en)를 26.01으로 업데이트
