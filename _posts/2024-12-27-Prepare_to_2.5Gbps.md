...
그런데, 뒤져보니 이미 [어떤 귀인](https://github.com/bb-qq)께서 [RTL8156을 지원하는 드라이버](https://github.com/bb-qq/r8152)를 만들어 놓으셨다.
...
**추가**꞉ [본진의 이슈 페이지](https://github.com/bb-qq/r8152/issues/275)에 명시되어 있듯이 일부 NAS 기종에서는 속도 저하의 문제가 있다.\
DS418도 이 문제에 해당된다.
