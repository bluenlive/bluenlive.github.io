...
![image](/images/2024-10-06/apikey_B_Q.webp)
...
![image](/images/2024-10-06/roadaddr_B_Q.webp)
...
{% include bnl_download-box.html
   file="/attachment/2024-10-06/RoadAddress.rar"
   password="teus.me" %}
...
- 2024.9.14꞉ 1.02 공개
  - 칼럼 헤더 클릭으로 정렬 기능 추가
  - 검색 후 칼럼 폭 자동으로 다시 맞춤

- 2024.9.21꞉ 1.03 공개
  - API 키를 가끔 제대로 저장하지 못하던 문제 수정
  - HiDPI를 제대로 지원하도록 수정
  - 칼럼 폭 자동으로 맞추는 기능을 개선
