...
- 2025.12.4꞉ v3.30
  ...
  - 이미지 라이브러리 업데이트
    ...
    - [libpng](https://github.com/pnggroup/libpng){:target="_blank"}를 1.8.0.git(Nov 25, 2025)으로 업데이트
    - [zlib-ng](https://github.com/zlib-ng/zlib-ng){:target="_blank"}를 2.3.2(dec 8, 2025)로 업데이트
