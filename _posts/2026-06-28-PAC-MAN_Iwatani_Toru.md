...
기획자였던 이와타니 토루를 필록으로 프로그래머 한 명, 하드웨어 엔지니어 한 명, 그리고 음악과 그래픽을 담당한 이들까지 **단 5명**이서 **역사적인 대작**을 만들어 낸 것이다.\
...
프로세싱 파워가 넘쳐나는 시대가 아니라 최소한의 개념과 제한된 자원 속에서 이 정도의 지능을 구현해 냈다는 점은 지금 봐도 경이롭다.
...
몇 해 전에 구글은 ooo이벤트로 이를 즐길 수 있게 공개했었다. (링크 필요)
