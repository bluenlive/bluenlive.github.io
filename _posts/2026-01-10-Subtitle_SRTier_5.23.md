...
![image](/images/2026-01-10c/srtier_B_okl_s64_Q.webp)
...
- 둘 이상의 자막을 한번에 표기하기 위한 대쉬(-)가 어색한 경우[^1] 이를 정리
- SSA/ASS 자막 효과[^2]가 적용된 경우 이를 제거
...
- **시간 수정**: 시간이 겹치는 자막들이 있으면 옵션에 따라 **분리해서 재배치**하거나, **시간을 조절**함
...
- 2026.1.10꞉ v5.31 공개
  - UI 미세 튜닝: 입력창 탭 순서 조정

[^1]: 첫 줄엔 대쉬가 없는데 둘째 줄에 있거나, 대쉬가 한 번만 등장하는 경우 등
[^2]: 많은 미디어 재생기에서 이를 지원함
