...
최근 [libpng](https://github.com/pnggroup/libpng){:target="_blank"}는 1.8.0 beta 단계로 들어왔고, [zlib-ng](https://github.com/zlib-ng/zlib-ng/commits/develop/){:target="_blank"}는 2.3.0 RC1 단계로 들어왔다.\
