...
layout: single
#classes: wide
title: "구라제거기(키보드 보안 프로그램 삭제) 7.34 업데이트"
#date: 2024-5-1
categories:
  - HoaxEliminator
...
프로그램 특성 상 Win32 API의 기능만을 사용하기 때문에, 디자인에 대한 제약이 있지만, 최대한 노력해주고 계신다.

그리고, 7.17부터 띄웠던 [토스 아이디](https://toss.me/bluenlive){:target="_blank"}는 토스의 서비스 종료로 조만간 삭제될 예정이다.

![image](/images/2024-07-06/hoax_B_Q.png){: .align-center}
*창의 디자인은 지속적으로 바뀔 예정*
