...
우주 분야를 파이썬으로 다룰 땐 [astropy](https://www.astropy.org/)와 [poliastro](https://docs.poliastro.space/en/stable/)가 가장 중요한 라이브러리들이다.  
여담이지만, astropy에서 사용되는 **unit**은 그 자체만으로 사용하기에도 편리하다.

![image](/images/2024-03-24/astropy_Q.webp)
...
![image](/images/2024-03-24/poliastro_Q.webp)

때가 되면 해결될 것이라 생각하면서 파이썬 3.10을 사용하고 있었는데, 문제는 그게 아니었다.  
[깃허브 poliastro 소스](https://github.com/poliastro/poliastro)을 보니 개발이 중단되고 아카이빙 된 것이다.
...
직접 손을 댈 수 있는 규모도 아니라 방법을 찾아보니 이미 귀인께서 [hapsira](https://hapsira.readthedocs.io/en/stable/)라는 것을 만들어 놓으셨다.  
...
![image](/images/2024-03-24/hapsira_Q.webp)
