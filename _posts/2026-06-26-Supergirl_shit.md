...
주체적인 서사를 지우고 겉포장만 그럴싸하게 꾸민 할리우드식 **수동적 PC 클리셰**를 그대로 부어버렸다.
...
게다가 가는 **행성들의 풍경이 모두 대동소이**해서 **싸구려 영화라는 느낌**을 지울 수도 없는 건 덤이다.
...
심지어 **잭 스나이더의 DCEU**에서 이미 **아쿠아맨**을 연기 했던 배우의 **배가 나온 모습**은 대체… 휴…
