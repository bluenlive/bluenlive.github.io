...
{% include bluenlive/new-version.html url="/notepad4/Notepad4-r5332/" %}

[이전 글](/notepad4/Notepad4/)에서 언급했듯이 Notead2-mod 프로젝트가 Notepad4로 이름을 바꾸었다.\
...
![image](/images/2024-06-09/notepad4_Bs64_Q.png)

아래 링크에서 다운받을 수 있으며, 언제나 그렇듯 x86/x64/avx2 버전이 함께 들어있다.

{% include bluenlive/download-box.html
   file="/attachment/2024-06-09/Notepad4_r5311.zip"
   password="teus.me" %}
...
- 2024.6.10꞉ 24.05 r5295 선공개
  ...
  - 마크다운 lexer 오류 수정 ([링크](https://github.com/zufuliu/notepad4/commit/f0b9e1aba513c1fd94dcaf2ba7f0f46b2b9e199c))
