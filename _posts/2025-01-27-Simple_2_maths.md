...
이 부분을 일반화해보면 다음과 같다.\
$$1+3+5+\cdots+(2n-1)+\cdots+5+3+1 = 2\left(1+3+5+\cdots+\left(2n-1\right)\right) - (2n-1) = 2n^2-2n+1$$
...
$$\frac{2\cdot4\cdot5\cdot9}{6} - 4^2 &= 44\\ \frac{2\cdot10\cdot11\cdot21}{6} - 10^2 &= 670$$
