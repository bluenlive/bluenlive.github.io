...
categories:
  - MyProgram
new_version_url: "/myprogram/Family-Photo-Organizer-10.00/"
---
...
![image](/images/2026-02-13b/pics1_B_Q.webp)
*피쳐폰 - 똑딱이 - 작티 순 정렬...*
...
![image](/images/2026-02-13b/pics2_B_Q.webp)
*촬영날짜/시간 순 정렬 완료!*
...
- JPEG 파일을 읽을 때 노이즈(JPEG Artifacts)를 제거하는 옵션 추가([jpeg-quantsmooth](https://github.com/ilyakurdyukov/jpeg-quantsmooth) 적용)
...
- 2026.2.13: v9.31 공개
  ...
  - 이미지 라이브러리 업데이트
    - [jpeg-quantsmooth](https://github.com/ilyakurdyukov/jpeg-quantsmooth)를 1.20260122으로 업데이트
