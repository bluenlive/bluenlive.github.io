...
categories:
  - iDevice
tags: ["VMAF", "RTX", "ffmpeg"]
toc: true
toc_label: "Contents"
#toc_icon: "cog"
toc_icon: "book-open"
toc_sticky: true
new_ver_app_url: "/idevice/iTrans-v20.38/"
---
...
![image](/images/2024-05-01c/iTrans_Bs64_Q.webp)
...
{% include bnl_download-box.html
   file="/attachment/2024-05-01/iTrans_v20.29.rar"
...
&nbsp;\
![image](/images/2024-05-01c/iOS_Sub.webp)
...
[FFmpeg](http://ffmpeg.org/download.html), [MediaInfo](http://mediainfo.sourceforge.net/en), [MP4Box](https://gpac.wp.imt.fr/), [Nero AAC Encoder](http://www.videohelp.com/software/Nero-AAC-Codec), [qaac](https://sites.google.com/site/qaacpage/)
...
- 2024.2.6꞉ v20.28
  ...
  - [qaac](https://sites.google.com/site/qaacpage/)를 2.81로 업데이트
  - [MediaInfo](http://mediainfo.sourceforge.net/en)를 24.01.1로 업데이트

- 2024.5.1꞉ v20.29
  - 내부적으로 시간 계산시 부정확한 `GetTickCount64()`를 완전히 배제
  - [FFmpeg](http://ffmpeg.org/download.html)을 7.0\[gyan.dev\]로 업데이트
  - [MediaInfo](http://mediainfo.sourceforge.net/en)를 24.04로 업데이트
  - [qaac](https://sites.google.com/site/qaacpage/)를 2.82로 업데이트
