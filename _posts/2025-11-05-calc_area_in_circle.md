...
짧게 말하면, 각 블럭의 면적은 사분원의 높이 함수 $$y(x)=\sqrt{L^2-x^2}$$를 블럭의 세로 구간 $$[y_0,y_1]$$로 잘라낸 뒤 $$x$$ 방향으로 적분해 정확히 계산할 수 있다.
...
이는 사분원의 면적 $$ \frac{\pi 6^2}{4} = 28.274333882308139 $$과 동일하다.
