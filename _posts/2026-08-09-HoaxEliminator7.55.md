...
layout: single
#classes: wide
title: "구라제거기(키보드 보안 프로그램 삭제) 7.60 업데이트"
date: 2026-8-9 22:33:00 +0900
categories:
  - HoaxEliminator
...
![image](/images/2026-08-09/hoaxelem_B_okl_s64_Q.webp)
...
{% include bnl_download-box.html
   file="/attachment/2026-08-09/HoaxEliminator7.60.zip"
   password="teus.me" %}
...
- 2026.4.15: v7.56
  - **오픈소스 라이선스** 표시 기능 추가
  - 정규식 목록 **구조 최적화 및 통합**
  - Google/Abseil 라이브러리를 20260107.1 버전(Abseil LTS branch, January 2026, Patch 1)으로 업데이트

- 2026.6.8: v7.58
  - Google/Abseil 라이브러리를 20260526.0 버전(Abseil LTS branch, May 2026)으로 업데이트
  - Zstd 라이브러리를 1.6.0.git 버전(2026.5.15)으로 업데이트
  - 기타 다양한 내부 코드 구조 개선

- 2026.8.9: v7.60
  - 대상 프로그램 추가
    So∗∗Ca∗∗ We∗ Stand∗∗∗ Secur∗∗∗ Pack∗∗∗
    보∗∗∗부 인∗∗ 발∗ 프로∗∗
    중∗Ag∗∗∗ 1.1.2.5
  - 대상 프로그램 목록 중 오타 수정 **(AI 믿지 맙시다)**
  - 라이브러리 업데이트
    - Zstandard로 라이브러리를 1.6.0.git 버전(2026-8-1)으로 업데이트
