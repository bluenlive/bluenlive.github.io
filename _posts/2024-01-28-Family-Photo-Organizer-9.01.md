...
- 텍스트 데이터를 통한 Exif 생성
- JPEG 외에 PNG / GIF / WebP / MKV / MP4 / MOV / AVI까지 파일명 수정하며,<br>
...
[Download](</attachment/2024-01-28/FPO_v9.01.rar>){: .btn .btn--info}[FPO_v9.01.rar](</attachment/2024-01-28/FPO_v9.01.rar>)
...
* 2024.1.28꞉ v9.01 공개
  * 인텔 IPP 라이브러리를 사용하도록 수정 (동시에 x86 지원 종료)
