...
A.R.C. (Automatic relay computer) 용으로 **Kathleen Booth**와 **Andrew Donald Booth** 두 분이 최초로 개발하셨다.  
**이진수 곱셈 알고리즘**을 개발한 그 A. D. Booth 맞다.  
이런 쉬운 언어로 프로그램 만들려고 하면 안 된다고 **폰 노이만**에게 한 소리 들었단 얘기가 있다.

이 어셈블리어에 대한 페이퍼는 [여기](https://albert.ias.edu/server/api/core/bitstreams/d47626a1-c739-4445-b0d7-cc3ef692d381/content){:target="_blank"}에서 볼 수 있다.

![image](</images/2024-11-17/Booth1946.jpg>){: .align-center}
...
![image](</images/2024-11-17/John_Backus_2.jpg>){: .align-center}
...
![image](</images/2024-11-17/John_McCarthy_Stanford.jpg>){: .align-center}
...
![image](</images/2024-11-17/Hopper.jpg>){: .align-center}
...
해당 문서는 [여기](https://bitsavers.trailing-edge.com/pdf/dartmouth/BASIC_Oct64.pdf){:target="_blank"}에서 볼 수 있다.

![image](</images/2024-11-17/basicfounders1.jpg>){: .align-center}
...
컴퓨터 언어에 대한 압도적인 개발 공로로 **1984년에 튜링상**을 수상하셨다.

![image](</images/2024-11-17/Niklaus_Wirth,_UrGU.jpg>){: .align-center}
...
![image](</images/2024-11-17/Ritchie.jpg>){: .align-center}
...
![image](</images/2024-11-17/Colmerauer_3.jpg>){: .align-center}
...
![image](</images/2024-11-17/Jean_Ichbiah.jpg>){: .align-center}
