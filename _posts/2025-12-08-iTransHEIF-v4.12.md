---
layout: single
title: "아주 빠른 HEIF 이미지 변환기 iTrans HEIF 4.14 업데이트"
...
[윈도우 11에서도 뷰어를 다운](https://www.microsoft.com/store/productId/9PMMSR1CGPWG?ocid=pdpshare)받으면 간단히 볼 수 있고, [반디뷰](https://kr.bandisoft.com/bandiview/)에서도 이를 지원한다.
...
![image](/images/2025-12-08/iTransHEIF_B_okl_s64_Q.png){: .align-center}
...
- 2025.11.21꞉ v4.12
  ...
  - [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo)를 3.1.2로 업데이트(Aug 26, 2025)
  - [FFmpeg](http://ffmpeg.org/download.html)을 8.0\[gyan.dev\]으로 업데이트
  - [libpng](https://github.com/pnggroup/libpng)를 1.8.0.git(Nov 7, 2025)으로, [zlib-ng](https://github.com/zlib-ng/zlib-ng)를 2.3.0-rc2(Nov 18, 2025)로 업데이트

- 2025.12.8꞉ v4.14
  - UI 미세 조정
    - **Windows 10** 문구를 **Windows 11**로 변경
  - 병렬 처리 개수 축소
  - [FFmpeg](http://ffmpeg.org/download.html)을 8.0.1\[gyan.dev\]로 업데이트
  - [libpng](https://github.com/pnggroup/libpng)를 1.8.0.git(Dec 8, 2025)으로, [zlib-ng](https://github.com/zlib-ng/zlib-ng)를 2.3.2(Dec 8, 2025)로 업데이트
