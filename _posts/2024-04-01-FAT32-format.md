...
얼마 전 [arstechnica.com](https://arstechnica.com/gadgets/2024/03/windows-current-disk-formatting-ui-is-a-30-year-old-placeholder-from-windows-nt/)에 재미있는 글이 올라왔다.  
윈도우의 디스크 포맷 UI가 30년 전부터 변하지 않았다는 것이다.

![image](/images/2024-04-01/format_Q.webp)
...
[**Ridgecrop Consultants Ltd FAT32 Format**](http://www.ridgecrop.demon.co.uk/index.htm?guiformat.htm)은 이 바닥의 사실상 원조에 가까운 프로그램.  
처음엔 **CLI**로만 사용할 수 있었지만, **GUI** 버전도 나왔고, **x64** 버전도 별도로 나왔다.

![image](/images/2024-04-01/guiformat_B_Q.webp)

### 0xbadfca11 / fat32format

[**0xbadfca11 / fat32format**](https://github.com/0xbadfca11/fat32format)은 **CLI**로 사용하는 프로그램이다.  
Ridgecrop의 프로그램을 개선시킨 프로그램이다.

### Big FAT32 Formatter

[**Big FAT32 Formatter**](https://www.bureausoft.com/big-fat32-format-tool.html)는 **GUI**로 사용하는 프로그램이다.  
표시되는 정보가 제일 많기는 하다...

![image](/images/2024-04-01/Big-FAT32-Format_B_Q.webp)
