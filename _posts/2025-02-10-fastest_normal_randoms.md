...
그런데, [`sse_mathfun.h`](http://gruntthepeon.free.fr/ssemath/)와 같은 **초고속 근사 라이브러리**를 사용하는 방법이 있다.\
...
![image](/images/2025-02-09c/float_Bs64_Q.webp)
...
![image](/images/2025-02-09c/double_Bs64_Q.webp)
...
- [miloyip/normaldist-benchmark](https://github.com/miloyip/normaldist-benchmark)
- [정규분포 난수를 만들어 주세요 #4 : Box-Muller 방법](https://sine-qua-none.tistory.com/47)
