...
{% include bluenlive/reconstruction.html
   url="https://zockr.tistory.com/74"
   link_text="이전 블로그(ZockrWorld)"
   message="에서 일부 이미지가 사라져버려, 이미지 복원차 현 블로그로 옮긴 글입니다"
%}

![image](/images/2024-07-25a/Goldfinger_1st_novels64.jpg)
...
*※ 레바논에서는 학생들도 이 영화를 볼 수 있도록 관람료를 내려달라는 시위가 있을 정도였음*{: .desc}
...
게다가 오프닝 장면에서 잠수복을 입고 잠입한 뒤 잠수복을 벗자 **속에 정장을 입고 있다**는 기막힌 설정은 후에 아놀드 형님의 007 패러디 영화 〈True Lies〉 오프닝에서 그대로 사용되었다.

![image](/images/2024-07-25a/TrueLiess64.jpg)

실제, 이 소설이 나온 뒤에 가장 크게 제기되던 문제점은 과연 엄청난 양의 금을 "털" 수 있냐는 것이었다.\
금괴의 양이 1만톤이 넘는데, 이를 어느 세월에 "터냐"는 것…\
소설에서는 이를 적절하게 설명하기는 했지만*\(이런 부분이 Ian Fleming 소설의 매력 중 하나임\)*{: .desc} 그런다고 말이 되는 것은 아니다…\
...
![image](/images/2024-07-25a/spielberg-topaz-faceai-enhance-2xs64.jpg)
*스티븐 스필버그*

이 사진은 스티븐 스필버그 감독이다. 〈GF〉를 보고나서 정말 007 영화의 감독을 맡고 싶어했던 분이다.\
〈Indiana Jones 3편〉에서 Sean Connery가 캐스팅된 것은 결코 우연이 아니다.\
스필버그 감독의 애차가 Aston Martin이다. 이건 〈GF〉의 영향. *\(본인이 인정한 사실임\)*{: .desc}
...
![image](/images/2024-07-25a/goldfingerposters64.jpg)
...
*※ 레이저 무기가 실용적으로 사용된 최초의 영화임*{: .desc}
