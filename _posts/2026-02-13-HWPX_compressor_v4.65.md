...
![image](/images/2026-02-13c/HIS_B_okl_s64_Q.webp)
*드디어 TIFF를 지원!*

읽고 압축할 수 있는 파일 포맷에 TIFF를 추가했다.\
이를 위해 [LibTIFF](https://gitlab.com/libtiff/libtiff/)보다 가볍고, 읽기 기능에 특화된 [tiffloader](https://github.com/MalcolmMcLean/tiffloader)를 사용했다.
...
- 2025.3.8꞉ v4.65
  ...
  - [libzip](https://github.com/nih-at/libzip/)을 1.11.2(2024.12.22)로 업데이트
...
- 2025.11.6꞉ v4.70
  ...
  - 툴팁 색을 Oklab 기반으로 튜닝
  - 내부 라이브러리 업데이트
    - [mozJPEG](https://github.com/mozilla/mozjpeg)을 v5.0.0.dev(Jun 24, 2025)로 업데이트
    - [libpng](https://github.com/pnggroup/libpng)를 1.6.50(July 2, 2025)로 업데이트
    - [zlib-ng](https://github.com/zlib-ng/zlib-ng)를 2.2.5(Aug 7, 2025)으로 업데이트
    - [libimagequant](https://pngquant.org/)를 4.5.0으로 업데이트 (2025.7.30)
...
- 2025.12.5꞉ v4.76
  ...
  - 내부 라이브러리 업데이트
    - [libpng](https://github.com/pnggroup/libpng)를 1.8.0.git(Dec 4, 2025)으로 업데이트
    - [zlib-ng](https://github.com/zlib-ng/zlib-ng)를 2.3.2(dev 4, 2025)로 업데이트
    - [libzip](https://github.com/nih-at/libzip/)을 1.11.4(2025.11.7)로 업데이트
...
- 2026.2.13꞉ v4.81
  ...
  - 내부 라이브러리 업데이트
    - [libzip](https://github.com/nih-at/libzip/)를 [libzip-win-build](https://github.com/kiyolee/libzip-win-build)로 교체 및 1.11.4-p1로 업데이트  
    - [libpng](https://github.com/pnggroup/libpng)를 1.8.0.git(Feb 11, 2026)으로 업데이트
    - [zlib-ng](https://github.com/zlib-ng/zlib-ng)를 2.3.3(Feb 4, 2026)로 업데이트
    - [libimagequant](https://pngquant.org/)를 4.5.0(Feb 11, 2026 추가 반영)으로 업데이트 (2026.2.13)
