...
toc_icon: "book-open"
toc_sticky: true
new_version_url: "/idevice/iTrans-v21.00/"
---
...
![image](/images/2025-11-21/iTrans_B_okl_s64_Q.webp)

인코딩 HW에 적용했던 [MainConcept HEVC 인코더](https://teus.tistory.com/769)에 대해 좀 더 정확한 기능을 적용하였다.

변환기는 아래 링크에서 다운받을 수 있으며, 여전히 별도의 설치 프로그램 따위는 없다.

{% include bnl_download-box.html
   file="/attachment/2025-11-21/iTrans_v20.38.rar"
...
재생 가능 여부는 [iOS 5.x에서 수정된 규칙](https://zockr.tistory.com/1114)에 따라 확인함\
또한, 사용자 선택시 H.264/HEVC로 재인코딩할 수 있음
2. 비디오 재인코딩은 FFmpeg을 사용하며, 재인코딩시 디인터레이스 및 영상을 회전시킬 수 있음\
이 때, S/W(x264, x265) 뿐만 아니라 [H/W(NVENC, AMF, 인텔 QSV 및 MainConcept)](https://teus.tistory.com/645) 인코딩도 가능함
...
- 재생 가능 비디오만 변환꞉ [iOS 5.x에서 수정된 규칙](https://zockr.tistory.com/1114)에 맞는 비디오만 추출 (재인코딩 없음)
- 필요시 비디오 재인코딩꞉ [iOS 5.x 이상에서 재생가능](https://zockr.tistory.com/1114)한 비디오는 추출, 그 외는 H.264/HEVC로 재인코딩\
...
&nbsp;\
![image](/images/2025-11-21/iOS_Sub.webp)
...
[FFmpeg](http://ffmpeg.org/download.html), [MediaInfo](http://mediainfo.sourceforge.net/en), [MP4Box](https://gpac.wp.imt.fr/), [Nero AAC Encoder](http://www.videohelp.com/software/Nero-AAC-Codec)
...
- 2025.11.21꞉ v20.38
  ...
  - 내부 어플리케이션 업데이트 및 변경
    ...
    - [MediaInfo](http://mediainfo.sourceforge.net/en)를 25.10으로 업데이트
